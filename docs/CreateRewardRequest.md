...
```typescript
import type { CreateRewardRequest } from '@briskstack/platform'
...
const example = {
  ...
  "badgeId": 123e4567-e89b-12d3-a456-426614174002,
} satisfies CreateRewardRequest
...
const exampleParsed = JSON.parse(exampleJSON) as CreateRewardRequest
